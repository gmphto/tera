...
MESSAGE_BY_CODE = {
    ...
    "invalid_project_id": "The project id is malformed.",
    "unknown_slot": "The slot is not one this palette has.",
    "invalid_context": "The song context is malformed or unsupported.",
    ...
    "project_exists": "A project already exists; this version works in one project.",
    "role_mismatch": "The sample's stored role is not one this slot accepts.",
